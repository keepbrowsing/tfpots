...
<head>
  ...
  <meta name="author" content="TF Pots">
  <meta name="keywords" content="ecommerce,decoration,store">
  <meta name="description" content="Murrumbung Studio Ceramics is a small, independent ceramics studio in Melbourne, Australia">
    ...
    <div class="search-popup-container">
      ...
      <ul class="cat-list">
        <li class="cat-list-item">
          <a href="#" title="Bonsai Pots">Bonsai Pots</a>
        </li>
		<li class="cat-list-item">
          <a href="#" title="By Shape">By Shape</a>
        </li>
        <li class="cat-list-item">
          <a href="#" title="Cosmetics">By Size</a>
        </li>
        <li class="cat-list-item">
          <a href="#" title="Wood Fired">Wood Fired</a>
        </li>
        <li class="cat-list-item">
          <a href="#" title="Dresses">Gift Voucher</a>
        </li>
        <li class="cat-list-item">
          <a href="#" title="Jumpsuits">Other Pots</a>
        </li>
		  <li class="cat-list-item">
          <a href="#" title="Kusamono pots">Kusamono pots</a>
        </li>
      </ul>
...
<g>
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="#" class="dropdown-item item-anchor">All</a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">By Shape</a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">By Size</a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Woodfire</a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Gift Voucher</a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Kusamono Pots</a>
                    </li>
                  </ul>
                </li>
				  <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Latest News </a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Latest E-News </a>
                    </li>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/images/bonsai-pots-ceramics-murrumbung-01.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <p>Unique & Distinctive</p>
        <p class="txtLarge">Designs</p>
		<button type="button" class="btn btn-light">SHOP NOW</button>
      </div>
    </div>
    <div class="carousel-item">
      <img src="assets/images/bonsai-pots-ceramics-murrumbung-02.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <p>Inspired by</p>
		  <p class="txtLarge">Natural Beauty</p>
		<button type="button" class="btn btn-light">SHOP NOW</button>
      </div>
    </div>
    <div class="carousel-item">
      <img src="assets/images/bonsai-pots-ceramics-murrumbung-03.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
       <p>Sustainable & Traditional</p>
		  <p class="txtLarge">Designs</p>
		<button type="button" class="btn btn-light">SHOP NOW</button>
      </div>
    </div>
  ...
  <div class="row">
	  <div class="col-lg7 col-md-6 col-sm-12">
		  <h1 class="section-title" data-aos="fade-up">About Us</h1>
		  <p data-aos="fade-up" data-aos-delay="300">Murrumbung Studio Ceramics is a small, independent ceramics studio in Melbourne, Australia.
Murrumbung Studio Ceramics is known for its unique and distinctive designs, which are inspired by the natural beauty of the surrounding landscape, as well as traditional Japanese pottery and ceramics techniques.<br/><br/>
The studio also places a strong emphasis on sustainability, using locally sourced materials and eco-friendly production methods wherever possible.</p>
		  <button type="button" class="btn btn-dark">CONTACT US</button>
	  </div>
	  <div class="col-lg5 col-md-6 col-sm-12">
		  <img class="rounded" alt="..." src="assets/images/bonsai-pots-ceramics-murrumbung-03.jpg"/>
	  </div>
  </div>
</div>
	</section>
  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        <h2 class="section-title text-center" data-aos="fade-up">Latest Collections</h2>
      </div>
      <div class="row">
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="assets/images/bonsai-pots-ceramics-murrumbung-01.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  ...
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Shop Now</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="assets/images/bonsai-pots-ceramics-murrumbung-02.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="assets/images/bonsai-pots-ceramics-murrumbung-03.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
  ...
  <section id="new-arrival" class="new-arrival product-carousel py-5 position-relative overflow-hidden">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <h3 class="section-title " data-aos="fade-up">New Arrivals</h3>
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="index.html">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-01.jpg" alt="categories" class="product-image img-fluid">
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="index.html">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-02.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="index.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <a href="index.html">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-03.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="index.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
      ...
      <div class="row">
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src="assets/images/murrumbung-studio-ceramics-unique-japanese.jpg" alt="collection" class="product-image img-fluid">
            </div>
          </div>
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-5 m-0 m-md-5">
              <h4 class="section-title" data-aos="fade-up">TF Classic Collection</h4>
  ...
  <section id="best-sellers" class="best-sellers product-carousel py-5 position-relative overflow-hidden">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        <h5 class="section-title " data-aos="fade-up">Best Selling Items</h5>
        <a href="index.html" class="btn-link">View All Products</a>
      </div>
      <div class="swiper product-swiper open-up" data-aos="zoom-out">
        <div class="swiper-wrapper d-flex">
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="index.html">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-02.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="index.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="video-content open-up" data-aos="zoom-out">
          <div class="video-bg">
            <img src="assets/images/bonsai.jpg" alt="video" class="video-image img-fluid">
          </div>
          <div class="video-player">
            <a class="youtube" href="https://www.youtube.com/watch?v=cZtZPjl3gcI">
              <svg width="24" height="24" viewBox="0 0 24 24">
                <use xlink:href="#play"></use>
              </svg>
              <img src="assets/images/collection.svg" alt="pattern" class="text-rotate">
            </a>
          </div>
        </div>
      </div>
  ...
  <section class="testimonials py-5 bg-light">
    <div class="section-header text-center mt-5">
      <h6 class="section-title">WE LOVE GOOD COMPLIMENT</h6>
    </div>
      ...
      <div class="swiper-wrapper d-flex">
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Perfectly designed bonsai pot, more elegant than expected, durable, and incredibly smooth.”</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Exquisitely crafted bonsai pot, beautifully balanced, sturdy, and effortlessly stylish.”</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“A finely made bonsai pot, surpassing expectations with its elegance, durability, and smooth finish.”</p>
              <div class="review-title text-uppercase">uptop</div>
            </blockquote>
          </div>
        </div>
  ...
  <section id="related-products" class="related-products product-carousel py-5 position-relative overflow-hidden">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        <h6 class="section-title">You May Also Like</h6>
        <a href="index.html" class="btn-link">View All Products</a>
      </div>
      <div class="swiper product-swiper open-up" data-aos="zoom-out">
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="#">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-01.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="index.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                <a href="#">
                  <img src="assets/images/bonsai-pots-ceramics-murrumbung-03.jpg" alt="product" class="product-image img-fluid">
                </a>
                <a href="index.html" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
  ...
  <section class="blog py-5">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
        ...
        <a href="index.html" class="btn-link">Read All News</a>
      </div>
      <div class="row">
        <div class="col-md-4">
         <article class="post-item">
            <div class="post-image">
              <a href="index.html">
                <img src="assets/images/bonsai.jpg" alt="image" class="post-grid-image img-fluid">
              </a>
            </div>
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              <div class="post-meta text-uppercase fs-6 text-secondary">
                <span class="post-category">Decoraation /</span>
                <span class="meta-day"> jul 11, 2022</span>
              </div>
              <h6 class="post-title">
                <a href="index.html">Your News Post Title Goes Here...</a>
              </h6>
      ...
      <div class="row justify-content-center">
        <div class="col-md-8 py-5 my-5">
          <div class="subscribe-header text-center pb-3">
            <h6 class="section-title text-uppercase">Newsletter Sign Up</h6>
          </div>
  ...
  <section class="instagram position-relative">
    <div class="d-flex justify-content-center w-100 position-absolute bottom-0 z-1">
      <a href="https://www.instagram.com/murrumbungstudioceramics/" class="btn btn-dark px-5" target="_blank">Follow us on Instagram</a>
    </div>
    <div class="row g-0">
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="#" target="_blank">
            <img src="assets/images/ig1.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="assets/images/ig2.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/templatesjungle/" target="_blank">
            <img src="assets/images/ig3.jpg" alt="instagram" class="insta-image img-fluid">
          </a>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2">
      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="assets/images/TF-white.svg" alt="logo">
              </a>
            </div>
            <p>Murrumbung Studio Ceramics is a small, independent ceramics studio in Melbourne, Australia.</p>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            <h6 class="widget-title text-uppercase mb-4">Quick Links</h6>
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
                <a href="index.php" class="item-anchor">Home</a>
              </li>
              <li class="menu-item">
                <a href="#" class="item-anchor">Shop</a>
              </li>
              <li class="menu-item">
                <a href="#" class="item-anchor">Portfolio</a>
              </li>
              <li class="menu-item">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-003">
            <h6 class="widget-title text-uppercase mb-4">Help & Info</h6>
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            <h6 class="widget-title text-uppercase mb-4">Contact Us</h6>
            <p>Do you have any questions or suggestions?<br/><a href="mailto:info@fpots.com.au"
                class="item-anchor">info@fpots.com.au</a></p>
            <p>Do you need support? <br/>Give us a call. <a href="tel:+61 459 555 346" class="item-anchor">+61 459 555 346</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2025 TF Pots. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var stickyThreshold = 100; // Change point
